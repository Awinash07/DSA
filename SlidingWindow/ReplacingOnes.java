package SlidingWindow;public class ReplacingOnes {
    public static int findLength(int[] arr, int k) {
        ...
        for (int windowEnd = 0; windowEnd < arr.length; windowEnd++) {
            ...
            if (windowEnd - windowStart + 1 - maxOnesCount > k) {//windowSize - max ones count in window = no of 0s in windowSize > k(which should not Exceed value of k)
